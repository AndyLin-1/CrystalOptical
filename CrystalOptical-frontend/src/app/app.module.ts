...
@NgModule({
  declarations: [AppComponent, AppHeaderComponent, AppFooterComponent, ItemDataComponent, RelatedItemComponent, CreateAccountComponent, LogInComponent, PaymentComponent, ChatbotComponent],
  imports: [
    BrowserModule,
    AppRoutingModule,
    FormsModule,
